...
public class ventanaVerGananciasPromotor extends JFrame {
    ...
    public ventanaVerGananciasPromotor(Promotor promotor, SistemaPersistencia sistema) {
    ...
    private void inicializarComponentes() {
        setTitle("Ganancias del Promotor - " + promotor.getLogin());
        setSize(900, 650);
        ...
        JLabel lblTitulo = new JLabel("ESTADO FINANCIERO DEL PROMOTOR");
    ...
    private void cargarDatos() {
        ...
        promotor.verGanancias(sistema.getAdministrador().getCobroEmision());
        
        // Obtener estados financieros
        EstadosFinancieros ef = promotor.getEstadosFinancieros();
        ...
        for (Tiquete t : promotor.getTiquetes()) {
            if (t.isTransferido()) {
                vendidos++;
            } else if (!t.isAnulado()) {
                disponibles++;
    ...
    private void volverAlMenu() {
   	 ...
   	 dispose();
        new ventanaMenuPromotor( promotor, sistema).setVisible(true);
